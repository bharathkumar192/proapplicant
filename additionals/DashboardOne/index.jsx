        ...
        <div className="flex flex-1 flex-col gap-5 items-center justify-start md:px-5 w-full">
          ...
          <div className="flex flex-col font-poppins items-center justify-center sm:px-5 px-6 w-full">
            <div className="flex flex-col gap-5 items-start justify-start w-full">
              ...
              >
                <div className="bg-white-A700 flex flex-1 flex-col items-start justify-start sm:px-5 px-[38px] py-[22px] rounded shadow-bs1 w-full">
              ...
              <div className="flex md:flex-col flex-row font-inter gap-5 items-start justify-start w-full">
                <div className="flex flex-1 flex-col items-center justify-start w-full">
                  <div className="bg-white-A700 flex flex-col items-start justify-start max-w-[761px] sm:px-5 px-8 py-[26px] rounded shadow-bs1 w-full">
                    <div className="flex flex-col gap-[31px] h-[343px] md:h-auto items-center justify-center w-full">
                      <div className="flex flex-row sm:gap-10 items-center justify-between w-full">
                        ...
                        <Button
                          className="bg-white-A700 border border-bluegray-200 border-solid cursor-pointer flex items-center justify-center min-w-[172px] px-[15px] py-2.5 rounded shadow-bs1"
                          leftIcon={
                            <Img
                ...
                <div className="flex flex-col h-[395px] md:h-auto items-start justify-start w-auto">
                  <div className="bg-deep_orange-300 flex flex-col items-center justify-center md:px-10 sm:px-5 px-[85px] py-[5px] rounded-tl rounded-tr shadow-bs1 w-[370px] sm:w-full">
                    <Img
              ...
              <div className="flex md:flex-col flex-row font-inter gap-5 items-start justify-start w-full">
                      ...
                      <div className="flex flex-1 flex-col gap-4 items-start justify-start w-full">
                        <div className="flex flex-row items-center justify-between w-full">
                          ...
                          <Text
                            ...
                            size="txtInterMedium16Bluegray800"
                          >
                            Visa
                          </Text>
                        </div>
                ...
                <div className="bg-white-A700 flex flex-col items-start justify-start px-4 py-8 rounded shadow-bs1 w-auto">
